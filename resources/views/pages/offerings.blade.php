<x-layouts.marketing title="Offerings" description="What we do at Linking Circles Academy.">
    <section class="lc-container py-16">
        <h1 class="lc-section-title">What We Do</h1>
        <p class="mt-6 max-w-3xl text-base leading-8">
            Our offerings are designed to create practical academic outcomes while supporting
            educators and families with long-term learning tools.
        </p>
