    ...
    <section class="lc-container py-16">
        ...
        <div class="mt-10 grid gap-8 md:grid-cols-2">
            <article class="lc-card">
                <h2 class="text-lg font-semibold text-heading">Get in Touch</h2>
            ...
            <form class="lc-card" aria-describedby="contact-help">
                <p id="contact-help" class="mb-4 text-sm text-content">This starter clone includes the UI only. Submit handling can be wired next.</p>
                ...
                <label for="email" class="mt-4 block text-sm font-medium text-heading">Email</label>
                ...
                <label for="message" class="mt-4 block text-sm font-medium text-heading">Message</label>
                <textarea id="message" name="message" rows="5" class="mt-2 w-full rounded-md border border-zinc-300 px-3 py-2 text-sm"></textarea>

                <button type="button" class="mt-4 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700">
                    Send Message
                </button>
            </form>
        </div>
