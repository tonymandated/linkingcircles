<x-layouts.marketing title="Home" description="Serving Academic Excellence to African Students Globally.">
    <section class="bg-white">
        <div class="lc-container grid gap-10 py-16 md:grid-cols-2 md:items-center">
            <div>
                <p class="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary">
                    Endorsed by Education Partners
                </p>
                <h1 class="mt-4 font-serif text-4xl font-semibold leading-tight text-heading md:text-6xl">
                    Serving Academic Excellence to African Students Globally
                </h1>
                <p class="mt-5 max-w-2xl text-lg leading-8 text-content">
                ...
                <div class="mt-8 flex flex-wrap gap-3">
                    <a href="{{ route('programs') }}" wire:navigate class="rounded-md bg-primary px-5 py-3 text-sm font-semibold text-white hover:bg-sky-700">
                        Explore Programs
                    </a>
                    <a href="{{ route('contact') }}" wire:navigate class="rounded-md border border-zinc-300 px-5 py-3 text-sm font-semibold text-heading hover:bg-zinc-50">
                        Contact Us
                    </a>
                </div>
            </div>
    ...
    <section class="lc-container py-16">
        ...
        <div class="mt-8 grid gap-6 md:grid-cols-3">
            <article class="lc-card">
                <h3 class="font-serif text-2xl font-semibold text-heading">Virtual Learning</h3>
            ...
            <article class="lc-card">
                <h3 class="font-serif text-2xl font-semibold text-heading">Teacher Training</h3>
                <p class="mt-3 text-sm leading-7">
            ...
            <article class="lc-card">
                <h3 class="font-serif text-2xl font-semibold text-heading">Cultural Heritage Programs</h3>
                <p class="mt-3 text-sm leading-7">
    ...
    <section class="bg-white py-16">
        <div class="lc-container">
            ...
            <div class="mt-8 grid gap-6 md:grid-cols-2">
                <article class="lc-card">
                    <p class="font-semibold text-heading">Accessible and Inclusive Delivery</p>
                    <p class="mt-2 text-sm leading-7">Programs are designed to be clear, supportive, and accessible for diverse learners.</p>
                </article>
                <article class="lc-card">
                    <p class="font-semibold text-heading">Trusted Learning Community</p>
    ...
    <section class="lc-container py-16">
        ...
        <a href="{{ route('programs') }}" wire:navigate class="mt-6 inline-flex rounded-md bg-primary px-5 py-3 text-sm font-semibold text-white hover:bg-sky-700">
            Get Started Now
        </a>
    </section>
</x-layouts.marketing>
