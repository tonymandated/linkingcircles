<x-layouts.marketing title="Project TECI" description="Project TECI at Linking Circles Academy.">
    <section class="lc-container py-16">
        <h1 class="lc-section-title">Project TECI</h1>
        <p class="mt-6 max-w-4xl text-base leading-8">
            Project TECI is a focused initiative supporting teacher effectiveness and classroom impact
            through structured training, mentoring, and implementation support.
        </p>
